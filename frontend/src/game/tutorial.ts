...
export const STEPS: TutorialStep[] = [
  ...
  {
    id: "power",
    title: "1 · Light the reactor",
    body: "Everything needs power. Pick the Reactor from the toolbar, then click an empty tile — your crew will build it.",
    target: "power",
    done: (s) => has(s, "power"),
  },
  {
    id: "cooling",
    title: "2 · Raise a cryo tower",
    body: "GPUs run hot. Pick Cryo and place a crystal tower — without it, servers overheat and shut off.",
    target: "cooling",
    done: (s) => has(s, "cooling"),
  },
  {
    id: "rack",
    title: "3 · Place a compute hub",
    body: "Compute hubs hold your GPU servers. Pick Compute and drop one on the floor.",
    target: "rack",
    done: (s) => has(s, "rack"),
  },
  {
